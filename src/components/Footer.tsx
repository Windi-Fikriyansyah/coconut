        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16 mb-12 md:mb-20">
          ...
          {/* <div>
            ...
            <p className="text-xs text-coco-forest/50 mb-6 leading-relaxed">
              Subscribe to stay updated with global coconut market trends and
              commodity prices.
            </p>
            <form className="relative">
              ...
              <button
                suppressHydrationWarning
                className="absolute right-2 top-2 bottom-2 bg-coco-forest text-coco-sandy px-3 rounded-lg text-xs font-bold hover:bg-coco-leaf transition-all"
              >
                Join
              </button>
            </form>
